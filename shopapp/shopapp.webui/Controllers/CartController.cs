    ...
    public class CartController:Controller{
        ...
        public IActionResult Index(){
            ...
            return View(new CartModel(){
                CartId = cart.Id,
                CartItems = cart.CartItems.Select(i=>new CartItemModel(){ //CartItems listesinde tek tek dolaşarak her bir objeyi CartItemModel içerisine atıyoruz
                    CartItemId = i.Id,
                    Name = i.Product.Name,
        ...
        private void SaveOrder(OrderModel model, Payment payment, string userId)
        {
            ...
            order.OrderItems = new List<entity.OrderItem>(); //entity içerisinde constructor içerisinde de tanımlayabilirsin
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-5IT3NAYzIArJfMXDLOHhc0Bs07LrdRsf";
            options.SecretKey = "sandbox-M8mOTGH7vYOTJ8a2uvWuAsAjyiGkuHrD";
